...
# - If mariadbd-safe exits (e.g., mariadbd segfault), fail fast instead of
#   looping indefinitely and consuming the full CI timeout (60 min).
# - Maximum wait: 120 seconds as a safety net.
mariadb_wait_secs=0
